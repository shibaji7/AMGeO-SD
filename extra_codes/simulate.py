...
if __name__ == "__main__":
    ...
    parser.add_argument("-pl_xu", "--plt_xulim", type=int, default=24, help="Upper X-lim of plotting (default 18)")
    parser.add_argument("-pl_xl", "--plt_xllim", type=int, default=-2, help="Lower X-lim of plotting (default -2)")
    parser.add_argument("-pl_yu", "--plt_yulim", type=int, default=110, help="Upper Y-lim of plotting (default 70)")
