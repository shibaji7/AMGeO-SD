...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--start", default=dt.datetime(2015,3,17), help="Start date (default 2015-03-16)", 
            type=prs.parse)
    parser.add_argument("-e", "--end", default=dt.datetime(2015,3,18), help="End date (default 2015-03-17)", 
            type=prs.parse)
    ## TODO, add cluster, enable filter, velocity threshold for Ribiero Th
    parser.add_argument("-f", "--dofilter", action="store_true", help="Do filtering (default False)")
    parser.add_argument("-ct", "--docluster", action="store_false", help="Do clustering (default True)")
    ...
    parser.add_argument("-vth", "--velocity_threhold", type=float, default=25., help="Velocity threshold for Ribiero Method")
    ...
    parser.add_argument("-gmm", "--run_gmm", default="", type=str, help="Run GMM algorithm for clustering (bmnum/themis(T)/all(A))")
    parser.add_argument("-nc", "--n_clusters", default=5, type=int, help="Maximum allowable clusters by GMM")
    parser.add_argument("-cov", "--cov", default="full", type=str, help="Covariance type in GMM")
    parser.add_argument("-gth", "--n_data_th", default=100, type=int, help="GMM numb. of data poins in a cluster")
